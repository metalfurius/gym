...
export const LOAD_TYPE_VALUES = [DEFAULT_LOAD_TYPE, 'bodyweight'];
...
export function resolveExerciseLoadType(exercise = {}) {
    return normalizeLoadType(exercise.tipoCarga ?? exercise.loadType ?? exercise.load_type ?? exercise.tipo_carga);
}
