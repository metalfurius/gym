...
const dictionaries = {
    es: {
        ...
        'auth.errors.email_already_in_use': 'Este email ya esta registrado. Intenta iniciar sesi\u00f3n.',
        'auth.errors.weak_password': 'La contrase\u00f1a es demasiado debil (m\u00ednimo 6 caracteres).',
        ...
        'history.no_connection_warning': 'Estas sin conexi\u00f3n. No se pudo cargar el historial.',
        ...
        'history.delete_confirm': 'Estas seguro de que quieres eliminar "{name}"? Esta acci\u00f3n no se puede deshacer.',
        ...
        'settings.cache_warning': 'Eliminar el cache borrara los datos de sugerencias guardados localmente. Los datos de tus sesiones en la nube no se ver\u00e1n afectados.',
        'settings.cache_delete_btn': 'Eliminar cache local',
        'settings.clear_cache_confirm': 'Estas seguro de que quieres eliminar el cache local?\n\nEsto borrara las sugerencias de ejercicios guardadas localmente. Los datos de tus sesiones en la nube no se ver\u00e1n afectados.\n\nEl cache se reconstruira automaticamente la proxima vez que inicies sesi\u00f3n.',
        ...
        'version.force_update_confirm': 'Estas seguro de que quieres forzar la actualizaci\u00f3n de la aplicaci\u00f3n? Esto limpiara el cache y recargara la pagina.',
