...
const dictionaries = {
    es: {
        ...
        'dashboard.daily_hub_weekly_progress': 'Progreso semanal',
        'dashboard.daily_hub_current_streak': 'Racha actual (semanas)',
        'dashboard.daily_hub_best_streak': 'Mejor racha (semanas)',
        'dashboard.weekly_progress_value': '{days}/{target}',
        ...
        'session.invalid_inputs': 'Corrige los campos marcados antes de guardar la sesi\u00f3n.',
        'session.input_invalid': 'Introduce un valor v\u00e1lido.',
        'session.input_incomplete': 'Completa este campo antes de guardar.',
        'session.input_range': 'El valor debe estar entre {min} y {max}.',
        'session.weight_input_invalid': 'Introduce un peso v\u00e1lido (por ejemplo, 62,5).',
        'session.weight_input_incomplete': 'Completa el peso antes de guardar.',
        'session.weight_input_range': 'El peso debe estar entre {min} y {max} kg.',
        'session.user_weight_input_invalid': 'Introduce un peso corporal v\u00e1lido (por ejemplo, 75,4).',
        'session.user_weight_input_incomplete': 'Completa tu peso corporal antes de guardar.',
        'session.user_weight_input_range': 'Tu peso debe estar entre {min} y {max} kg.',
        'session.reps_input_invalid': 'Las repeticiones deben ser n\u00fameros enteros no negativos (por ejemplo, 8).',
        'session.reps_input_incomplete': 'Completa las repeticiones antes de guardar.',
        'session.reps_input_range': 'Las repeticiones deben estar entre {min} y {max}.',
        'session.weight_input_label': 'Peso de la serie {index} (kg)',
        'session.reps_input_label': 'Repeticiones de la serie {index}',
        ...
        'version.force_update_confirm':
            '\u00bfQuieres instalar ahora la actualizaci\u00f3n de la aplicaci\u00f3n? Tu entrenamiento actual se conservar\u00e1.',
        'version.updated_title': 'Aplicaci\u00f3n actualizada',
        'version.updated_message': 'Version {version} instalada correctamente',
        'version.update_available':
            'Actualizaci\u00f3n v{version} en curso. Tu entrenamiento actual se conservar\u00e1.',
        'version.update_reloading': 'Aplicaci\u00f3n actualizada. Recargando de forma segura...',
        'version.update_check_error':
            'No se pudo comprobar la actualizaci\u00f3n; se reintentar\u00e1 autom\u00e1ticamente.',
        'version.update_recovery_error':
            'La actualizaci\u00f3n no se complet\u00f3. Tu entrenamiento actual se ha conservado.',
    ...
    en: {
        ...
        'dashboard.daily_hub_weekly_progress': 'Weekly progress',
        'dashboard.daily_hub_current_streak': 'Current streak (weeks)',
        'dashboard.daily_hub_best_streak': 'Best streak (weeks)',
        'dashboard.weekly_progress_value': '{days}/{target}',
        ...
        'session.invalid_inputs': 'Correct the marked fields before saving the session.',
        'session.input_invalid': 'Enter a valid value.',
        'session.input_incomplete': 'Complete this field before saving.',
        'session.input_range': 'The value must be between {min} and {max}.',
        'session.weight_input_invalid': 'Enter a valid weight (for example, 62.5).',
        'session.weight_input_incomplete': 'Complete the weight before saving.',
        'session.weight_input_range': 'Weight must be between {min} and {max} kg.',
        'session.user_weight_input_invalid': 'Enter a valid body weight (for example, 75.4).',
        'session.user_weight_input_incomplete': 'Complete your body weight before saving.',
        'session.user_weight_input_range': 'Your weight must be between {min} and {max} kg.',
        'session.reps_input_invalid': 'Repetitions must be non-negative whole numbers (for example, 8).',
        'session.reps_input_incomplete': 'Complete the repetitions before saving.',
        'session.reps_input_range': 'Repetitions must be between {min} and {max}.',
        'session.weight_input_label': 'Set {index} weight (kg)',
        'session.reps_input_label': 'Set {index} repetitions',
        ...
        'settings.weekly_goal_saved_queued': 'Weekly target queued. It will sync when connection is restored.',
        'settings.weekly_goal_save_error': 'Error saving weekly target.',
        'settings.weekly_goal_requires_login': 'You must be signed in to save the weekly target.',
        'settings.weekly_goal_save_offline': 'Offline. Weekly target will be saved when you are back online.',
        'settings.weekly_goal_save_window_closed': 'You can only change the weekly target from Monday to Wednesday.',
        'settings.weekly_goal_save_limit_reached': 'You already used the 3 allowed target changes for this week.',
        ...
        'version.force_update_confirm': 'Install the app update now? Your current workout will be preserved.',
        'version.updated_title': 'Application updated',
        'version.updated_message': 'Version {version} installed successfully',
        'version.update_available': 'Update v{version} is being installed. Your current workout will be preserved.',
        'version.update_reloading': 'Application updated. Reloading safely...',
        'version.update_check_error': 'The update could not be checked; it will be retried automatically.',
        'version.update_recovery_error': 'The update did not complete. Your current workout was preserved.',
